...
public sealed class AddAttribinterParameters
{
    private static IServiceCollection Target(IServiceCollection services) => AttribinterParametersServices.AddAttribinterParameters(services);

    private readonly IServiceProvider ServiceProvider;

    public AddAttribinterParameters()
    {
